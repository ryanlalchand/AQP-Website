...
const tables = ["customer", "line_item", "nation", "order", "part", "partsupp", "region", "supplier"];
const files = ["customer.tbl", "lineitem.tbl", "nation.tbl", "orders.tbl", "part.tbl", "partsupp.tbl", "region.tbl", "supplier.tbl"];
